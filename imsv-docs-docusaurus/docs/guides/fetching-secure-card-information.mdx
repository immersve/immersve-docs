...
1. Call the [get a card token](/api-reference/get-a-card-token) endpoint with the card ID.
...
![Card Secure Details Sequence Diagram](/img/diagrams/card-secure-details-sequence.svg)
