...
:::caution
The [Get secure card details](/api-reference/get-secure-card-details) endpoint **must** be called using the secure server domain `api-sec.immersve.com` in order to be PCI compliant.
:::
